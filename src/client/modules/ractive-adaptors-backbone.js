...
(function ( global, factory ) {
  ...
  if ( typeof module !== 'undefined' && module.exports && typeof require === 'function' ) {
    factory( require( 'ractive/ractive.runtime' ), require( 'ampersand-model' ), require( 'ampersand-rest-collection' ) );
  }
  ...
  // AMD?
    ...
    throw new Error( 'Could not find Ractive or Ampersand! Both must be loaded before the ractive-adaptors-backbone plugin' );
  }

}( typeof window !== 'undefined' ? window : this, function ( Ractive, Model, RestCollection ) {

  'use strict';

  var ModelWrapper, CollectionWrapper, lockProperty = '_ractiveAdaptorsBackboneLock';

  if ( !Ractive || !Model || !RestCollection ) {
    throw new Error( 'Could not find Ractive or Model or RestCollection! Check your paths config' );
  }
  ...
  Ractive.adaptors.Backbone = {
    filter: function ( object ) {
      return object && (object instanceof Model || object.isCollection);
    },
